...
This repo saves all the scripts for processing the 28 sample pairs on Phx in 2025 from March to May. The paper USRSE25_Nextflow_HPC.pdf has been submitted to the USRSE 2025 conference, which documented our investigations about running Nextflow-based software with Slurm.
